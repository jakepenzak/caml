...
| | |
| --- | --- |
| [CamlCATE](CamlCATE.qmd#caml.CamlCATE) | The CamlCATE class represents an opinionated framework of Causal Machine Learning techniques for estimating |
...
| [utils.cls_typechecked](utils.cls_typechecked.qmd#caml.utils.cls_typechecked) | Class decorator to typecheck all methods of a class. |
