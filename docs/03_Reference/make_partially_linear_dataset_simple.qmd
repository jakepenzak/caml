...
`extensions.synthetic_data.make_partially_linear_dataset_simple(n_obs=1000, n_covariates=10, n_confounders=5, dim_heterogeneity=2, binary_treatment=True, seed=None)`
