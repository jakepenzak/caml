...
```python
extensions.synthetic_data.CamlSyntheticDataGenerator(
    self,
    n_obs=10000,
    n_cont_outcomes=1,
    n_binary_outcomes=0,
...
| n_binary_confounders         | int         | Number of binary confounders ($W$).                                                                                                   | `2`        |
...
| n_binary_modifiers           | int         | Number of binary treatment effect modifiers ($X$).                                                                                    | `2`        |
