...
`CamlCATE(self, df, Y, T, X, W, *, discrete_treatment=True, discrete_outcome=False, seed=None, verbose=1)`
...
| `W`                  | list\[str\] \| str \| None                                    | The str (if unity) or list of feature names representing the confounder/control feature set to be utilized only for nuisance function estimation where applicable. | _required_ |
...
| _Y                    | ibis.Table                                                                     | The outcome variable data as ibis table.                                                                                                                                                                                      |
| _T                    | ibis.Table                                                                     | The treatment variable data as ibis table.                                                                                                                                                                                    |
| _X                    | ibis.Table                                                                     | The feature/confounder set data as ibis table.                                                                                                                                                                                |
| _X_T                  | ibis.Table                                                                     | The feature/confounder feature set and treatment variable data as ibis table.                                                                                                                                                 |
