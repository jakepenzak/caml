...
from caml.scorers import BaseScorer
from caml.scorers.base_scorer import clip, validate_cate_array, validate_scorer_inputs
...
class TestClipFunction:
    ...
    def test_clip_upper_bound(self):
        ...
        result = clip(arr, lb=0.01, ub=0.95)
...
class TestBaseScorerABC:
    """Test BaseScorer abstract base class."""

    def test_cannot_instantiate_directly(self):
        """Test that BaseScorer cannot be instantiated directly."""
...
class TestValidateCateArray:
    ...
    def test_1d_array_passes_through(self):
        ...
        result = validate_cate_array(arr, n_samples=5, name="test")
    ...
    def test_wrong_n_samples_raises(self):
        ...
        with pytest.raises(ValueError, match="has 3 samples, expected 5"):
            validate_cate_array(arr, n_samples=5, name="test_array")
    ...
    def test_2d_multiple_columns_raises(self):
        ...
        with pytest.raises(ValueError, match="2 columns"):
            validate_cate_array(arr, n_samples=3, name="test_array")
    ...
    def test_custom_name_in_error_message(self):
        ...
        with pytest.raises(ValueError, match="tau_hat"):
            validate_cate_array(arr, n_samples=10, name="tau_hat")
...
class TestValidateScorerInputs:
    ...
    def test_both_1d_same_shape(self):
        ...
        tau_result, ref_result = validate_scorer_inputs(tau_hat, reference)
    ...
    def test_different_n_samples_raises(self):
        ...
        with pytest.raises(ValueError, match="has 3 samples, expected 5"):
            validate_scorer_inputs(tau_hat, reference)
    ...
    def test_custom_names_in_error_messages(self):
        ...
        with pytest.raises(ValueError, match="my_tau"):
            validate_scorer_inputs(tau_hat, reference, tau_name="my_tau")
